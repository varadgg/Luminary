...
import DSAMastery from "/images/DSAMastery.png";
...
export default function CoursesGridSection({ search }) {
  ...
  return (
    <section className="py-12 lg:py-32 px-4 sm:px-6 lg:px-8 bg-surface">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 lg:mb-20 text-center">
          <h2 className="font-headline text-3xl lg:text-5xl font-bold text-on-surface tracking-tight mb-3 lg:mb-4">Elite Learning Paths</h2>
          <p className="font-body text-on-surface-variant text-base lg:text-xl">Curated paths for high-growth tech careers.</p>
        </div>
