...
export default function SolutionSection() {
  ...
  return (
    <motion.section ref={ref} className="py-16 lg:py-32 bg-surface-container-low relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center mb-10 lg:mb-20">
        <motion.h2
