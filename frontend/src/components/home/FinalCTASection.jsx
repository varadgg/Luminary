...
export default function FinalCTASection() {
  ...
  return (
    <motion.section
      ref={ref}
      style={{ opacity }}
      className="py-16 lg:py-32 bg-background relative overflow-hidden"
    >
      <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
        <motion.div
          className="p-8 lg:p-16 rounded-[2rem] lg:rounded-[3rem] bg-gradient-to-br from-surface-container-high to-slate-900 border border-outline-variant/20 shadow-2xl relative overflow-hidden group"
          style={{ scale, y }}
        >
